...
public class Dictionary {
    ...
    //
    // C++: static Ptr_Dictionary create(int nMarkers, int markerSize, Ptr_Dictionary baseDictionary, int randomSeed = 0)
    //

    //javadoc: Dictionary::create(nMarkers, markerSize, baseDictionary, randomSeed)
    ...
    //
    // C++: static Ptr_Dictionary create(int nMarkers, int markerSize, int randomSeed = 0)
    //
