...
public class Aruco {
    ...
    //
    // C++:  Ptr_Dictionary generateCustomDictionary(int nMarkers, int markerSize, Ptr_Dictionary baseDictionary, int randomSeed = 0)
    //

    //javadoc: generateCustomDictionary(nMarkers, markerSize, baseDictionary, randomSeed)
    ...
    //
    // C++:  Ptr_Dictionary generateCustomDictionary(int nMarkers, int markerSize, int randomSeed = 0)
    //

    //javadoc: generateCustomDictionary(nMarkers, markerSize, randomSeed)
